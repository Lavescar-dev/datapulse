...
Architecture note (2026-03-18):
- This implementation memo reflects the older Datapulse deployment shape.
- The active local architecture has been swapped to `demos/datapulse/app` (Astro + Hono + Bun).
- `demos/datapulse/frontend` remains available only for legacy reference and should not be treated as the primary execution path.
